# =======================================================================
#
# These codes are not written by the authors of SinIR
# Codes are obtained from https://github.com/thstkdgus35/bicubic_pytorch
#
# =======================================================================
...
def imresize(
    ...
    if scale == 1.0 or sides == x.shape[-2:]:
        return x.detach()
